[
// Either load the file tz_select.lasso during server or site startup,
// in server or site library, or include it.  Choose one method.
// I recommend site startup.
// include('tz_select.lasso'); // optional loading method
]<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
    <title>tz_select by Steve Piercy</title>
</head>
<body>
<h1>tz_select by Steve Piercy</h1>
...
[if(action_param('submit') != '');
    ...
    local('timezone' = action_param('timezone'));
